...
class ShopServerCompleteAuthorizeRequest extends AbstractRequest
{
    ...
    {
        return $this->response = new ShopServerCompleteAuthorizeResponse($this, $data);
    }
}
