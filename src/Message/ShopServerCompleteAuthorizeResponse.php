...
/**
 * Shop Authorize Response for the Server API (3d secure)
 */

use Omnipay\Common\Message\RedirectResponseInterface;

class ShopServerCompleteAuthorizeResponse extends AbstractResponse implements RedirectResponseInterface
{
